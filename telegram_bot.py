...
طُوِّر بواسطة: 𝗬𝗢𝗨𝗦𝗘𝗙 𝗚𝗢𝗢 | @X_3GB
"""
...
# ========== إعدادات البوت ==========
BOT_TOKEN = "8938383370:AAGf23e1yuQ8U8-rbbI6ubPLfuR2KTSfTnc"
API_BASE_URL = os.environ.get("API_BASE_URL", "https://goo-host.onrender.com")

# إيدي الأدمن على تليجرام
ADMIN_TELEGRAM_IDS = [8518059888]

# معلومات المطور
DEVELOPER_INFO = "🛠 طُوِّر بواسطة: *𝗬𝗢𝗨𝗦𝗘𝗙 𝗚𝗢𝗢*\n📬 تواصل: @X_3GB"
...
async def show_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE, edit=False):
    ...
    keyboard.append([InlineKeyboardButton("💬 تواصل مع المطور @X_3GB", url="https://t.me/YOUSEF_GOOY")])
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("💬 تواصل مع المطور @X_3GB", url="https://t.me/YOUSEF_GOOY")],
    ]
